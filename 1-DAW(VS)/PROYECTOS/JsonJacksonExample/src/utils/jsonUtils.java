...
public class jsonUtils {
	...
	public static Coche LeerCocheFromJsonFile(String relativePathFile)
    {
        ...
        System.out.println("Coche Object\n"+ coche);
        return coche;
	...
	public static List<Coche> LeerListCocheFromJsonFile(String relativePathFile)
	{
		File ficheroCochesArray = new File(relativePathFile);
		...
		try {
            listaCoches = objectMapper.readValue(ficheroCochesArray,  new TypeReference<List<Coche>>(){});
	...
	public static void crearFicheroCoches(List<Coche> listaCoches) {
		...
		try 
        {
			...
			//Puedo guardarlo en un fichero
            File nuevoFile = new File("src/recursos/cochesTodos.json");
	...
	public static People LeerPeopleFromJsonFile(String relativePathFile)
    {
        ...
        //File ficheroEmpleado = new File("src/recursos/employee.txt");
		File ficheroPeople = new File(relativePathFile);
        //byte[] jsonData = Files.readAllBytes(Paths.get("employee.txt"));
		...
		People gente = null;
        try {
            gente = objectMapper.readValue(ficheroPeople, People.class);
        } catch (IOException e) {
	...
	public static void crearFicheroPeople(People people) {
		...
		try 
        {
			...
			//Puedo guardarlo en un fichero
            File nuevoFile = new File("src/recursos/nuevoPeople.json");
            objectMapper.writeValue(nuevoFile, people);
			System.out.println("datos guardados correctamente");
	...
	public static HashMap<String, Persona> LeerMapaFromJsonFile(String relativePathFile)
    {
		...
		//convert json string to object
		HashMap<String, Persona> mapa = null;
        try {
            mapa = objectMapper.readValue(ficheroMapa, new TypeReference<HashMap<String, Persona>>(){});
        } catch (IOException e) {
	...
	public static void crearFicheroMapa(HashMap<String, Persona> mapa) {
		...
		try 
        {
			...
			//Puedo guardarlo en un fichero
            File nuevoFile = new File("src/recursos/nuevoMapa.json");
            objectMapper.writeValue(nuevoFile, mapa);
			System.out.println("datos guardados correctamente");
