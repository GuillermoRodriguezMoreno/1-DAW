...
import ClasesT6.Clases.EjemploDisco;

public class EjemploColeccionDisco {
    ...
    public static void main(String[] args) {
        ...
        EjemploDisco[] discos = new EjemploDisco[N];

        // Crea todos los discos que van en cada una de las celdas del array
        for(int i = 0; i < N; i++) {

            discos[i] = new EjemploDisco();
        }

        // Carga varios discos
        discos[0] = new EjemploDisco("GASA41", "Wim Mertens", "Maximazing the Audience", "instrumental", 50);
        discos[1] = new EjemploDisco("FGHQ64", "Metallica", "Black album", "hard rock", 46);
        discos[2] = new EjemploDisco("TYUI89", "Supersubmarina", "Viento de cara", "pop rock", 42);
        ...
        do {
            ...
            case 2:
                ...
                discos[primeraLibre] = new EjemploDisco(
